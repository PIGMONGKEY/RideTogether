...
public class MyPageCarpoolListAdapter extends BaseAdapter {
    ArrayList<MyPageCarpoolDataForm> item;
    Context context;

    public MyPageCarpoolListAdapter(ArrayList<MyPageCarpoolDataForm> item, Context context) {
        this.item = item;
