...
public class NewTaxi_Activity extends AppCompatActivity {
    ...
    private static final String TAG = "Lee-NewTaxi";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("새 택시 만들기");
    ...
    @RequiresApi(api = Build.VERSION_CODES.O)
    private void init() {
        sp = findViewById(R.id.newTX_startPointET);
        sp_d = findViewById(R.id.newTX_startPointDescET);
        de = findViewById(R.id.newTX_destinationET);
        de_d = findViewById(R.id.newTX_destinationDescET);
        admit_ET = findViewById(R.id.newTX_admit);
        timePicker = findViewById(R.id.newTX_timePicker);
        time = findViewById(R.id.newTX_timeTV);
        timePickerLinear = findViewById(R.id.newTX_timePickLinear);
        calendarView = findViewById(R.id.newTX_calendarView);
        calendarViewLinear = findViewById(R.id.newTX_calendarLinear);
        changeDate = findViewById(R.id.newTX_changeDate);
        changeTime = findViewById(R.id.newTX_changeTime);
        date = findViewById(R.id.newTX_date);
        sameG = findViewById(R.id.newTX_sameG);
        noSmoke = findViewById(R.id.newTX_noSmoke);
    ...
    //등록버튼 onClick
    @RequiresApi(api = Build.VERSION_CODES.O)
    public void taxiRegisterButton(View view) {
        setViewEnable(false);

        if(!emptyInfoCheck()) {
            errorString += "**";
            errorString = errorString.replace("\n**", "");
            AlertDialog.Builder builder = new AlertDialog.Builder(NewTaxi_Activity.this);
    ...
    private void requestCarpoolBoardRegister() {
        ...
        Call<NewTaxiDataForm> call = SCI.requestMakeNewTaxi(
                writer_pn,
                write_time,
                start_point,
                start_Point_D,
                ...
                gender,
                smoke);
        call.enqueue(new Callback<NewTaxiDataForm>() {
            @Override
            public void onResponse(Call<NewTaxiDataForm> call, Response<NewTaxiDataForm> response) {
                ...
                if(response.body().getResult().equals("success")) {
                    ...
                    AlertDialog dialog = builder.setMessage("등록 성공.")
                            ...
                            .setPositiveButton("확인", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Intent intent = new Intent(NewTaxi_Activity.this, TaxiBoard_Activity.class);
            ...
            @Override
            public void onFailure(Call<NewTaxiDataForm> call, Throwable t) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.profile: {
                Intent intent = new Intent(NewTaxi_Activity.this, MyPage_Activity.class);
                intent.putExtra("userInfo", userInfo);
                startActivity(intent);
                return true;
            }
